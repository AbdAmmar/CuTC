...
C_SRC = $(SRC_DIR)/cutc_int_c.c $(SRC_DIR)/deb_int_2e_ao.c $(SRC_DIR)/cutc_no_2e.c $(SRC_DIR)/deb_no_2e_cs.c
C_OBJ = $(BLD_DIR)/cutc_int_c.o $(BLD_DIR)/deb_int_2e_ao.o $(BLD_DIR)/cutc_no_2e.o $(BLD_DIR)/deb_no_2e_cs.o
