...
C_SRC = $(SRC_DIR)/cutc_int.c $(SRC_DIR)/cutc_no.c $(SRC_DIR)/deb_int_2e_ao.c $(SRC_DIR)/cutc_no_2e.c $(SRC_DIR)/cutc_no_1e.c $(SRC_DIR)/cutc_no_0e.c
C_OBJ = $(BLD_DIR)/cutc_int.o $(BLD_DIR)/cutc_no.o $(BLD_DIR)/deb_int_2e_ao.o $(BLD_DIR)/cutc_no_2e.o $(BLD_DIR)/cutc_no_1e.o $(BLD_DIR)/cutc_no_0e.o
