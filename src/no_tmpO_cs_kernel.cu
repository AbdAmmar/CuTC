...
__global__ void no_tmpO_cs_kernel(int n_grid1, int ne_b, 
...
extern "C" void no_tmpO_cs(int n_grid1, int ne_b,
                           double * mos_l_in_r, double * mos_r_in_r,
                           double * tmpO) {
    ...
    printf("lunching no_tmpO_cs_kernel with %d blocks and %d threads/block\n", nBlocks, blockSize);

    no_tmpO_cs_kernel<<<nBlocks, blockSize>>>(n_grid1, ne_b,
