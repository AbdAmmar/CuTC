...
__global__ void no_0e_tmpR_os_kernel(int n_grid1, int n_mo, int ne_b, int ne_a,
...
extern "C" void no_0e_tmpR_os(int n_grid1, int n_mo, int ne_b, int ne_a,
                              double * mos_r_in_r, double * int2_grad1_u12,
                              double * tmpR) {
    ...
    printf("lunching no_0e_tmpR_os_kernel with %d blocks and %d threads/block\n", nBlocks, blockSize);

    no_0e_tmpR_os_kernel<<<nBlocks, blockSize>>>(n_grid1, n_mo, ne_b, ne_a,
