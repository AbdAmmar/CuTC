...
__global__ void no_1e_tmpO_os_kernel(int n_grid1, int ne_b, int ne_a,
...
extern "C" void no_1e_tmpO_os(int n_grid1, int ne_b, int ne_a,
                              double * mos_l_in_r, double * mos_r_in_r,
                              double * tmpO) {
    ...
    printf("lunching no_1e_tmpO_os_kernel with %d blocks and %d threads/block\n", nBlocks, blockSize);

    no_1e_tmpO_os_kernel<<<nBlocks, blockSize>>>(n_grid1, ne_b, ne_a,
