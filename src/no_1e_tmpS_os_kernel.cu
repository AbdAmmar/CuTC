    ...
    while(i_grid1 < n_grid1) {
        ...
        for(ie = ne_b; ie < ne_a; ie++) {
            ...
            for(je = ne_b; je < ne_a; je++) {
                ...
                tmpS[i_grid1] -= 0.5 * int2_grad1_u12[iix            ] * int2_grad1_u12[jjx            ];
                tmpS[i_grid1] -= 0.5 * int2_grad1_u12[iix +   n_grid1] * int2_grad1_u12[jjx +   n_grid1];
                tmpS[i_grid1] -= 0.5 * int2_grad1_u12[iix + 2*n_grid1] * int2_grad1_u12[jjx + 2*n_grid1];
