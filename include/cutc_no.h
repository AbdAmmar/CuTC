...
extern void no_1e_tmpF_cs(int n_grid1, int n_mo, int ne_b, double * mos_r_in_r, double * int2_grad1_u12,
...
extern void no_1e_tmpE_os(int n_grid1, int n_mo, int ne_b, int ne_a, double * wr1, double * mos_l_in_r, double * int2_grad1_u12,
                          double * tmpJ, double * tmpL, double * tmpE);
extern void no_1e_tmpF_os(int n_grid1, int n_mo, int ne_b, int ne_a, double * mos_r_in_r, double * int2_grad1_u12,
                          double * tmpS, double * tmpJ, double * tmpR, double * tmpF);
